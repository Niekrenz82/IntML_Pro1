...
learner_lgb_base = lrn("regr.lightgbm", id = "lgb_l2", num_iterations = 500)

learner_lgb_poisson_base = lrn("regr.lightgbm", id = "lgb_poisson", objective = "poisson", num_iterations = 500)
learner_lgb_tweedie_base = lrn("regr.lightgbm", id = "lgb_tweedie", objective = "tweedie", num_iterations = 500)
learner_lgb_gamma_base = lrn("regr.lightgbm", id = "lgb_gamma", objective = "gamma", num_iterations = 500)
...
terminator = trm("evals", n_evals = 10) # Using 10 evals for speed; consider 20-50+
