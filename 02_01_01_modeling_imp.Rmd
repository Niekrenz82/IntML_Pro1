...
terminator_evals50 = trm("evals", n_evals = 20)
...
at_xgb   = AutoTuner$new(
  ...
  measure      = measure_mse,
  tuner        = tuner_rs,
  terminator   = terminator_evals50        # pulls the xgboost‐space, namespaced
)
...
learners = list(gl_lasso, at_xgb, at_ranger, gl_featless, gl_ridge)
...
```
```{r}
bmr$learners$learner[[2]]$param_set$values
```
